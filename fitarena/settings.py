...
# Course Payment URLs
FRONTEND_COURSE_SUCCESS_URL = os.getenv("FRONTEND_COURSE_SUCCESS_URL")
FRONTEND_COURSE_CANCEL_URL = os.getenv("FRONTEND_COURSE_CANCEL_URL")

# Slot Payment URLs
FRONTEND_SLOT_SUCCESS_URL = os.getenv("FRONTEND_SLOT_SUCCESS_URL")
FRONTEND_SLOT_CANCEL_URL = os.getenv("FRONTEND_SLOT_CANCEL_URL")
